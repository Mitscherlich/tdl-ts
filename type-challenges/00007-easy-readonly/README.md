...
Constructs a type with all properties of T set to read-only, meaning the properties of the constructed type cannot be reassigned.
...
3. Use the `readonly` keyword to set the properties to read-only.
