<!--info-header-start--><h1>Tuple to Object <img src="https://img.shields.io/badge/-easy-7aad0c" alt="easy"/> </h1>
<!--info-header-end-->
...
1. Use `T[number]` to get the value of the array.
2. Use `in` operator for loop array.
