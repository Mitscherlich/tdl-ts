<!--info-header-start--><h1>First of Array <img src="https://img.shields.io/badge/-easy-7aad0c" alt="easy"/> <img src="https://img.shields.io/badge/-%23array-999" alt="#array"/></h1>
<!--info-header-end-->
...
1. Use `infer` to infer the type of array item.
2. Use the spread operator `...` to collect the rest of the array.
